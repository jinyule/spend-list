...
class GetUpcomingRenewalsUseCase @Inject constructor(
    private val repository: SubscriptionRepository
) {
    suspend operator fun invoke(withinDays: Int = 3): List<Subscription> {
        return repository.getUpcomingRenewals(withinDays)
    }
}
